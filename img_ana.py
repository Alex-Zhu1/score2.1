...
# 示例调用
# analyze_image('/mnt/data/users/haiming.zhu/hoi/InvScore/demos/demo.png')
# analyze_image('/mnt/data/users/haiming.zhu/hoi/Hunyuan3D-2.1/hy3dshape/submodules/hamer/examples/325_cropped_hoi_1.png')
# analyze_image('/mnt/data/users/haiming.zhu/hoi/InvScore/data/325_cropped_hoi_1_hoi.png')
# analyze_image("/mnt/data/users/haiming.zhu/hoi/Hunyuan3D-2.1/hy3dshape/output_meshes/2025-10-23_16-29-44_670487/325_cropped_hoi_1.png")
# analyze_image("/mnt/data/users/haiming.zhu/hoi/InvScore/data/325_cropped_hoi_1nwe.png")
